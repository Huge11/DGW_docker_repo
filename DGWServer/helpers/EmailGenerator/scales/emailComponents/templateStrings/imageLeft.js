			...
			<tr>
				<td class="es-p20t es-p20r es-p20l esd-structure" align="left">
					...
					<table cellpadding="0" cellspacing="0" class="es-left" align="left">
						<tbody>
							<tr>
								<td width="360" class="es-m-p0r es-m-p20b esd-container-frame" valign="top" align="center">
									<table cellpadding="0" cellspacing="0" width="100%">
										<tbody>
											<tr>
												<td class="esd-block-image" align="center">
													<a target="_blank" href="${content.getImageUrl()}"><img class="adapt-img" src="${content.getImageUrl()}" alt="${content.getFormattedName()}" style="display: block;" width="360" title="${content.getFormattedName()}"></a></td>
											</tr>
										</tbody>
									</table>
								</td>
					...
					<table cellpadding="0" cellspacing="0" align="right">
						<tbody>
							<tr>
								<td width="180" align="left" class="esd-container-frame">
									<table cellpadding="0" cellspacing="0" width="100%">
										<tbody>
											<tr>
