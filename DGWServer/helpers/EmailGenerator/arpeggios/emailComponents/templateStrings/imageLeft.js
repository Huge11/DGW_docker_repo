										...
										<tbody>
											<tr>
												<td class="esd-block-image" align="center">
													<a target="_blank" href="${content.getImageUrl()}"><img class="adapt-img" src="${content.getImageUrl()}" alt="${content.getFormattedName()}" style="display: block;" width="360" title="${content.getFormattedName()}"></a>
												</td>
											</tr>
										</tbody>
									</table>
